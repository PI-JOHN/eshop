            ...
            <div class="col-lg-4">
                <div class="login-form">
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <input type="file" name="image" placeholder="" value="<?php Product::getImage( $product['image']); ?>">
                        ...
                        <select name="availability">
                            <option value="1" <?php if ($product['availability'] > 0) echo 'selected="selected"'; ?> >Да</option>
